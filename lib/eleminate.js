...
function eleminate(document, namespaces) {
    ...
    return function(name, attrs, children, text) {
        ...
        if (arguments.length === 2 && attrs instanceof Array)
            children = attrs, attrs = [];
        else if (arguments.length === 2 && typeof attrs === "string")
            text = attrs, attrs = {};
        else if (arguments.length === 3 && attrs instanceof Array)
            text = children, children = attrs, attrs = {};
        else if (arguments.length === 3 && typeof children === "string")
